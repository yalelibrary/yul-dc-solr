...
su solr -c 'precreate-core blacklight-core /opt/config; precreate-core blacklight-test /opt/config; cp -rn /opt/config/ /var/solr/data/${SOLR_CORE}/conf && touch /var/solr/data/${SOLR_CORE}/core.properties && exec solr -f'
